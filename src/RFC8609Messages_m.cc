...
void InterestMsg::copy(const InterestMsg& other)
{
    ...
    this->reflexiveNamePrefix = other.reflexiveNamePrefix;
    this->forwardPendingToken = other.forwardPendingToken;
    this->reversePendingToken = other.reversePendingToken;
...
void InterestMsg::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->reflexiveNamePrefix);
    doParsimPacking(b,this->forwardPendingToken);
    doParsimPacking(b,this->reversePendingToken);
...
void InterestMsg::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->reflexiveNamePrefix);
    doParsimUnpacking(b,this->forwardPendingToken);
    doParsimUnpacking(b,this->reversePendingToken);
...
const char * InterestMsg::getReflexiveNamePrefix() const
{
    return this->reflexiveNamePrefix.c_str();
}

void InterestMsg::setReflexiveNamePrefix(const char * reflexiveNamePrefix)
{
    this->reflexiveNamePrefix = reflexiveNamePrefix;
}

int InterestMsg::getForwardPendingToken() const
{
    return this->forwardPendingToken;
}

void InterestMsg::setForwardPendingToken(int forwardPendingToken)
{
    this->forwardPendingToken = forwardPendingToken;
}

int InterestMsg::getReversePendingToken() const
{
    return this->reversePendingToken;
}

void InterestMsg::setReversePendingToken(int reversePendingToken)
{
    this->reversePendingToken = reversePendingToken;
}
...
class InterestMsgDescriptor : public omnetpp::cClassDescriptor
{
  private:
    ...
    enum FieldConstants {
        ...
        FIELD_versionName,
        FIELD_segmentNum,
        FIELD_reflexiveNamePrefix,
        FIELD_forwardPendingToken,
        FIELD_reversePendingToken,
        FIELD_headerSize,
        FIELD_payloadSize,
        FIELD_hopsTravelled,
        FIELD_arrivalFaceID,
...
unsigned int InterestMsgDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_reflexiveNamePrefix
        FD_ISEDITABLE,    // FIELD_forwardPendingToken
        FD_ISEDITABLE,    // FIELD_reversePendingToken
...
int InterestMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "reflexiveNamePrefix") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "forwardPendingToken") == 0) return baseIndex + 7;
    if (strcmp(fieldName, "reversePendingToken") == 0) return baseIndex + 8;
    if (strcmp(fieldName, "headerSize") == 0) return baseIndex + 9;
    if (strcmp(fieldName, "payloadSize") == 0) return baseIndex + 10;
    if (strcmp(fieldName, "hopsTravelled") == 0) return baseIndex + 11;
    if (strcmp(fieldName, "arrivalFaceID") == 0) return baseIndex + 12;
    if (strcmp(fieldName, "arrivalFaceType") == 0) return baseIndex + 13;
...
const char *InterestMsgDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "string",    // FIELD_reflexiveNamePrefix
        "int",    // FIELD_forwardPendingToken
        "int",    // FIELD_reversePendingToken
...
std::string InterestMsgDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_reflexiveNamePrefix: return oppstring2string(pp->getReflexiveNamePrefix());
        case FIELD_forwardPendingToken: return long2string(pp->getForwardPendingToken());
        case FIELD_reversePendingToken: return long2string(pp->getReversePendingToken());
...
void InterestMsgDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_reflexiveNamePrefix: pp->setReflexiveNamePrefix((value)); break;
        case FIELD_forwardPendingToken: pp->setForwardPendingToken(string2long(value)); break;
        case FIELD_reversePendingToken: pp->setReversePendingToken(string2long(value)); break;
...
omnetpp::cValue InterestMsgDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_reflexiveNamePrefix: return pp->getReflexiveNamePrefix();
        case FIELD_forwardPendingToken: return pp->getForwardPendingToken();
        case FIELD_reversePendingToken: return pp->getReversePendingToken();
...
void InterestMsgDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_reflexiveNamePrefix: pp->setReflexiveNamePrefix(value.stringValue()); break;
        case FIELD_forwardPendingToken: pp->setForwardPendingToken(omnetpp::checked_int_cast<int>(value.intValue())); break;
        case FIELD_reversePendingToken: pp->setReversePendingToken(omnetpp::checked_int_cast<int>(value.intValue())); break;
...
int ContentObjMsg::getReversePendingToken() const
{
    return this->reversePendingToken;
}

void ContentObjMsg::setReversePendingToken(int reversePendingToken)
{
    this->reversePendingToken = reversePendingToken;
}
...
int ContentObjMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "reversePendingToken") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "headerSize") == 0) return baseIndex + 7;
    if (strcmp(fieldName, "payloadSize") == 0) return baseIndex + 8;
    if (strcmp(fieldName, "totalNumSegments") == 0) return baseIndex + 9;
    if (strcmp(fieldName, "payloadAsString") == 0) return baseIndex + 10;
    return base ? base->findField(fieldName) : -1;
}
...
const char * InterestRtnMsg::getReflexiveNamePrefix() const
{
    return this->reflexiveNamePrefix.c_str();
}

void InterestRtnMsg::setReflexiveNamePrefix(const char * reflexiveNamePrefix)
{
    this->reflexiveNamePrefix = reflexiveNamePrefix;
}

int InterestRtnMsg::getForwardPendingToken() const
{
    return this->forwardPendingToken;
}

void InterestRtnMsg::setForwardPendingToken(int forwardPendingToken)
{
    this->forwardPendingToken = forwardPendingToken;
}

int InterestRtnMsg::getReversePendingToken() const
{
    return this->reversePendingToken;
}

void InterestRtnMsg::setReversePendingToken(int reversePendingToken)
{
    this->reversePendingToken = reversePendingToken;
}
...
int InterestRtnMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "versionName") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "segmentNum") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "reflexiveNamePrefix") == 0) return baseIndex + 5;
    if (strcmp(fieldName, "forwardPendingToken") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "reversePendingToken") == 0) return baseIndex + 7;
